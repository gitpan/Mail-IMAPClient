...
consider please donating them to this module. I don't quite have a framework visualized
...
server, the server replies with a challenge. The authenticate then invokes the code 
whose reference is stored in the I<Authcallback> parameter as follows:
